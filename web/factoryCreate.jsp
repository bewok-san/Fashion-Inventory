...
<html>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Input Data Factory</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index">Home</a></li>
              <li class="breadcrumb-item"><a href="factory">Factory</a></li>
              <li class="breadcrumb-item"><a href="factoryCreate">Factory Input</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header"> Input Data Factory</div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                    ...
                    <label for="exampleInputId">Factory Name</label>
